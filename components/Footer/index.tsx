        ...
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <div className="py-20 lg:py-25">
            <div className="flex flex-wrap gap-8 lg:justify-between lg:gap-0">
              ...
              >
                <a href="index.html" className="relative">
                  <Image
                    width={110}
                    height={80}
                    src="/images/logo/naadvenu-logo.png"
                    alt="Logo"
              ...
              <div className="flex w-full flex-col gap-8 md:flex-row md:justify-center md:gap-0 lg:w-1/3 xl:w-7/12">
                <motion.div
                  variants={{
                    hidden: {
                      opacity: 0,
                  ...
                  viewport={{ once: true }}
                  className="animate_top w-100 width-100"
                >
          ...
          <div className="flex flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            ...
            >
              <p>
                &copy; {new Date().getFullYear()} Naadvenu. All rights reserved. Made by Akash A Soni
              </p>
            </motion.div>
