            ...
            <div className="animate_right hidden md:w-1/2 lg:block">
              <div className="relative 2xl:-mr-7.5">
                ...
                <div className="relative aspect-[700/444] w-full">
                  <Image
                    className="border border-4 border-white rounded shadow-solid-l dark:hidden"
                    src="/images/hero/naadvenu-light.jpg"
                    alt="Naadvenu Flute Classes"
                    fill
                  />
                  <Image
                    className="hidden border border-4 border-white rounded shadow-solid-l dark:block"
                    src="/images/hero/naadvenu-dark.jpg"
                    alt="Naadvenu Flute Classes"
                    fill
                  />
                </div>
