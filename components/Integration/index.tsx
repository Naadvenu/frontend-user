    ...
    <>
      <section>
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              ...
              description: `At Naadvenu Flute Classes, we believe in the power of music to transform lives. Our innovative MelodyForge program is designed to help you unlock your musical potential and master the art of Hindustani classical flute playing.`,
            }}
          />
        ...
        <div className="pattern-dots pattern-blue-500 pattern-bg-white pattern-size-4 pattern-opacity-10 relative z-50 mx-auto mt-15 max-w-c-1154 px-4 md:px-8 xl:mt-20 xl:px-0">
          ...
          <div className="flex flex-wrap equal-cols justify-around gap-y-10">
            <motion.div
              variants={{
                hidden: {
                  opacity: 0,
